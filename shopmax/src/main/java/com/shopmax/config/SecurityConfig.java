...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeHttpRequests(authorize ->
                ...
                authorize.requestMatchers("/css/**", "/js/**", "/img/**", "/images/**", "/fonts/**").permitAll()
                         .requestMatchers("/", "/members/**", "/item/**").permitAll() // localhost/, localhost/meber/모든하위경로
          ...
          .formLogin(formLogin ->
                  formLogin.loginPage("/members/login") // 로그인 페이지 URL
                ...
                .logout(logout ->
                        logout.logoutRequestMatcher(new AntPathRequestMatcher("/members/logout")) // 로그아웃했을때 이동할페이지 따로 controller작업이 필요없음.
