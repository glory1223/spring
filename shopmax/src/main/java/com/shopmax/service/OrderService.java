...
public class OrderService {
    ...
    public Long order(OrderDto orderDto, String email) {
        ...
        // 양방향이든 단방향이든 참조하는 객체를 무조건 넣은 후 에 save를 진행한다.
        // 양방향 일때는 부모 엔티티 객체가 참조하는 자식 객체를 넣은 후 save.
        // 단방향 일때는 자식 엔티티 객체가 참조하는 부모객체를 넣은 후 save.
    ...
    public Page<OrderHistDto> getOrderList(String email, Pageable pageable) {
        //1. 유저 아이디와 페이징 조건을 이용해서 주문 목록을 조회.
        ...
        for (Order order : orders) {
            ...
            // ★ 최종적으로는 orderItems 리스트를 orderHistDto에 있는 orderItemDtoList에 dto로 넣어주어야 한다.
